...
class UserControl:
    def __init__(self, user_params):
        ...
        self.area_x = user_params['area_x']
        self.area_y = user_params['area_y']
        self.max_simulation_time = user_params['max_simulation_time']
        self.delta_t = user_params['delta_t']
        self.users_number = user_params['users_number']
        self.drones_number = user_params['drones_number']
        self.groups_number = user_params['groups_number']
        self.groups_limits = user_params['groups_limits']
        self.users_speed = user_params['users_speed']
        self.users_height = user_params['users_height']
        self.r_max_k = user_params['r_max_k']
        self.total_time_steps = int(self.max_simulation_time / self.delta_t)
    ...
    def move(self):
        ...
        xy = np.sqrt(
            (self.users_goals[:, 1] - self.users[:, 1]) ** 2 + (self.users_goals[:, 0] - self.users[:, 0]) ** 2)
